...
export const researchCopy = {
  en: {
    ...
    interpretationNote: "Snacksmate interpretation of the study findings.",
  ...
  he: {
    ...
    interpretationNote: "פרשנות של Snacksmate לממצאי המחקר.",
